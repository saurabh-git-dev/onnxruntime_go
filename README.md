...
[`onnxruntime_go_examples` repository](https://github.com/saurabh-git-dev/onnxruntime_go_examples).
...
The full documentation can be found at [pkg.go.dev](https://pkg.go.dev/github.com/saurabh-git-dev/onnxruntime_go).
...
import (
    "fmt"
    ort "github.com/saurabh-git-dev/onnxruntime_go"
    "os"
)
